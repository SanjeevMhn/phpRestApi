                        ...
                        if ($levelCount == 1) {
                            ...
                            if ($auth['success'] == 1) {
                                ...
                                if (count($exists) > 0) {
                                    ...
                                    $res = $setUserWorkoutGoal->setUserGoal($id['id'], $userAge, $userGender, $goal, $userWeight, $weightMetric, $userLevel, $userHeight);
                                    if ($res) {
                                        echo json_encode(array(
                                            "success" => 1,
